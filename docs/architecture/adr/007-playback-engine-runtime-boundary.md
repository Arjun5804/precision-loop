...
6. **Cancellation Ownership:** The Playback Engine owns its own cancellation via `cancel()`. The orchestrating layer invokes this directly rather than trying to clean up Playback Engine internals.
